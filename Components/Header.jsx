    ...
    <div className='py-5 px-5 md:px-12 lg:px-28'>
        <div className="flex justify-between items-center">
            ...
            <div className='text-center my-8'>
                ...
                <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Lorem Ipsum is simply dummy text of the
                ...
                <form className='flex justify-between max-w-[500px] scale-75 sm:scale-100 mx-auto mt-10 border border-black shadow-[-7px_7px_0px_#000000]' action="">
                    ...
                    <button type='submit' className='border-l border-black py-4 px-2 sm:px-8 active:bg-gray-600 active:text-white'>Subscribe</button>
                </form>
            </div>
    </div>
  )
